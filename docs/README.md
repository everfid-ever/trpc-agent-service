...
第一次启动请阅读 [`runbook/getting-started.md`](./runbook/getting-started.md)。本仓库的可执行验收边界是 Docker Desktop：本地 Compose、单元/契约测试与最小后端 smoke；不提供 Kubernetes 发布、远端告警或外部 Provider 验收资产。
