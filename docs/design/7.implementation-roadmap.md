...
| 基础媒体安全 | provider-neutral Artifact staging、SSRF/DNS rebinding/大小/MIME/扫描 fail-closed、双 IM scoped 下载、prepared payload/ArtifactRef、ObjectStore 契约及 PostgreSQL 元数据/对象分层已完成；真实 scanner/ObjectStore provider、对象 GC/retention 和真实凭据 smoke 尚未完成 | 部分完成（fixture backend） |
