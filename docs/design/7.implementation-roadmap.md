...
| 基础媒体安全 | provider-neutral Artifact staging、SSRF/DNS rebinding/大小/MIME/扫描 fail-closed、双 IM scoped 下载、prepared payload/ArtifactRef、ObjectStore 分层及带有限重试/隔离态的 upload-intent orphan reconciler 已完成；当前仅回收 orphan，真实 scanner/ObjectStore provider、referenced Artifact retention（过期/租户删除）、隔离告警后端和真实凭据 smoke 尚未完成 | 部分完成（fixture backend） |
